...
export const EPLTable = () => {
  ...
  const buildTable = () => {
    ...
    return table
      ...
      .map((team) => {
        ...
        return (
          <>
            <Grow in={true} timeout={miliseconds}>
              <div key={team.teamid} className="team-info text-white">
                ...
                >
                  {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={350}>
                      <Paper className="popper-window">{currentTeam}</Paper>
                    </Fade>
                  )}
                </Popper>
                <IconButton
  ...
  return (
    <>
      <div id="epl-container">
        <div id="left-container-epl">
          <Link
            to="/builds"
            style={{
              textDecoration: "none",
          ...
          {table.length === 20 ? (
            <>
              <div className="info-header text-white">
                <Typography className="team-position-header">Pos.</Typography>

                <Typography className="team-name">Team</Typography>
                <Typography className="team-wins">W</Typography>
                <Typography className="team-draws">D</Typography>
                <Typography className="team-losses">L</Typography>
                <Typography className="team-points">Pts.</Typography>
              </div>
              {buildTable()}
            </>
          ) : (
            <>
              <div id="loader">
                <BounceLoader id="loader" color={"#FFFFFF"} size={120} />
        ...
        <div id="right-container-epl"></div>
      </div>
    </>
  );
};
